...
The analysis was written in the RStudio integrated development enviornment. This report was generated using the `rmarkdown` R package.
...
Imputation by Predicted Mean Matching is advantagous over other methods of data imputation because it "can provide valid inference when data are missing at random." (3)
